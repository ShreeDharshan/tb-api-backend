...
"""
Scheduler driving:
  1) Alarm loop (TB_SCHEDULER_INTERVAL)
  2) Live-counters daily flush loop (LC_TB_FLUSH_INTERVAL_SEC)

Set LC_TZ to control which "date" gets flushed; with Asia/Kolkata you'll get local-day buckets.
"""
